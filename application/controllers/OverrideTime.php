...
defined('BASEPATH') OR exit('No direct script access allowed');
  ...
  use Carbon\Carbon;
class OverrideTime extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_override_time_view') == 0 || $this->session->userdata('right_override_time_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['chck_authorization_stat'] = $this->session->userdata('right_override_time_authorization');
        ...
        $data['title'] = 'Override Time In/Out';

        $this->load->view('override_time_view', $data);
    }
    ...
    function transaction($txn = null) {
        ...
        switch ($txn) {
            ...
            case 'chck_authorization_stat':
              $response['data'] = $this->session->userdata('right_override_time_authorization');
