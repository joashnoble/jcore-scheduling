        ...
        switch($payrollreports){
            ...
            case 'emp_sched_report':
              ...
              $data['emp_info']=$this->Employee_model->get_list(
                            ...
                            'employee_list.*,CONCAT_WS(" ",employee_list.first_name,employee_list.middle_name,employee_list.last_name) as full_name
            ...
            $data['emp_sched_report']=$this->SchedEmployee_model->get_emp_sched_report_list($employee_id,$start_date,$end_date,$stat,$pay_period_id);
            $response = $this->load->view('template/employee_schedule_report_html',$data,TRUE);
            echo json_encode($response);
            break;
