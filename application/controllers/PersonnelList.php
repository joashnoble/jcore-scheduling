...
class PersonnelList extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_personnel_view') == 0 || $this->session->userdata('right_personnel_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $this->load->view('personnel_list_view', $data);
