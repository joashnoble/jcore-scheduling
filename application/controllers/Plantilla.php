...
class Plantilla extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_plantilla_view') == 0 || $this->session->userdata('right_plantilla_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['title'] = 'Plantilla (Monitoring)';

        $this->load->view('plantilla_view', $data);
    }
