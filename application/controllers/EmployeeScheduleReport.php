...
class EmployeeScheduleReport extends CORE_Controller
{
    ...
    function __construct() {
        ...
        if($this->session->userdata('right_employee_sched_view') == 0 || $this->session->userdata('right_employee_sched_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $this->load->view('employee_schedule_report_view', $data);
    }
