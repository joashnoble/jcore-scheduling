...
class SchedStats extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['employee_list']=$this->Employee_model->get_list(array('employee_list.is_deleted'=>FALSE,'employee_list.status="Active"'),'employee_list.*,CONCAT(employee_list.first_name," ",middle_name," ",employee_list.last_name) as full_name');
