            ...
            <div class="static-content" >
                <div class="page-content">
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="Daily_schedule">Daily Schedule</a></li>
                    </ol>
                    <div class="container-fluid">
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">Daily Schedule</h2></center>
                                </div>
...
$(document).ready(function(){
    ...
    var get_daily_schedule=function(){
        ...
        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"Daily_schedule/schedule/daily-schedule-demography/"+date+"/"+ref_department_id+"/fullview",
            beforeSend : function(){
    ...
    $(document).on('click','#print_sched_demography',function(){
        window.open('Daily_schedule/schedule/daily-schedule-demography/'+date+'/'+$('#ref_department_id').val()+'/print');
    });


    $(document).on('click','#pdf_sched_demography',function(){
        window.open('Daily_schedule/schedule/daily-schedule-demography/'+date+'/'+$('#ref_department_id').val()+'/pdf');
    });
