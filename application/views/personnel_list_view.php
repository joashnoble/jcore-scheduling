                                ...
                                <div class="panel-body table-responsive" style="padding-top:8px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" style="margin-left: 20px;" name="department_filter_list" id="department_filter_list" data-error-msg="Pay Period Filter is required" required>
                                            <option value="all">All</option>
                                            <?php
                                       ...
                                       <div class="row" style="margin-top: 30px;">
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_personnel_list" style="background-color:#27ae60; color:white;margin-left: 20px; width: 200px;">PRINT</button>
                                        </div>
                                    </div>
                                    </div>
                                    <hr>
