...
<head>
    ...
    <meta charset="utf-8">
    <title>JCOREScheduling - Login</title>
    ...
    <style>
      ...
      .new-login-register .lg-info-panel {
        background: url('assets/img/scheduling-bg.jpg') no-repeat center center / cover !important;
        width: 450px;
      }
      hr {
      ...
      <div class="lg-info-panel">
          <div class="inner-panel" style="width: 450px;">
              <div class="lg-content">
                  ...
                  <hr><h1 style="font-family: sans-serif!important; color: white;"><b>JCORE</b> SCHEDULING</h1><hr>
