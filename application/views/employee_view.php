                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="col-md-3">
                                                          ...
                                                          <div class="form-group">
                                                                ...
                                                                <input type="text" id="pin_number" name="pin_number" class="form-control" value="" data-error-msg="Pin Number is required!" required>
                                                                </div>
                                                          </div>
                                                        </div>
