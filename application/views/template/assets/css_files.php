...
<style>
   ...
   /*float:left;*/
	...
	.schedsetting, .breaksetting{
		cursor:pointer;
		transition: all 0.5s ease;

	}
	.schedsetting:hover, .breaksetting:hover{
		transition: all 0.5s ease;
		color:black;
    ...
    .tbl-header{
        ...
        .cdt{
            color:#FFF;font-size: 65pt;margin-left: -50px;margin-top: -15px;text-shadow: 2px 2px 4px #000000;
        }
        .tito{
        ...
        .thaa{
            color:black!important;display:block;font-size: 9pt!important;
        }
        .sattended{
        ...
        #image_name{
            margin-top:4px;width:400px;height:400px;margin:20px;border-radius: 50%;object-fit: cover;
        }
        .scanpanel{
