...
<body>
	...
	<table width="100%" style="border-collapse: collapse;padding: 20px;" cellpadding="5" cellspacing="5">
		...
		<thead>
			...
			<tr>
				<th style="font-size: 8pt;font-family: calibri!important;border: 1px solid gray!important;background: #C8C8C8!important;" width="1%"><center>#</center></th>
				<th style="font-size: 8pt;font-family: calibri!important;border: 1px solid gray!important;background: #C8C8C8!important;padding-left: 10px!important;text-align: left!important;" width="20%">Employee</th>

				<?php for ($i=0; $i <= 23; $i++) { ?>
					<th style="font-size: 7pt!important;font-family: calibri!important;border: 1px solid gray!important;background: #C8C8C8!important;" width="3%">
						<center>
							<?php if ($i == 0){ echo '12'; }
								else if($i == 13 ){ echo '1'; }
								else if($i == 14 ){ echo '2'; }
		...
		<?php 
			...
			?> 
			<tr>
				<td style="border: 1px solid #C8C8C8!important;font-size: 9pt!important;font-family: calibri!important;padding-left: 10px!important;padding-right: 10px!important;"><?php echo $a; ?></td>
