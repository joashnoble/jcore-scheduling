...
<body>
	...
	<?php }else if($type == "pdf"){ ?>
		...
		<br />
	<?php }?>
	<table width="100%" style="border-collapse: collapse;padding: 20px;color: black;border: 1px solid black!important;font-family: calibri;">
		
		<thead>
			<tr>
				<th style="font-size: 9pt;font-family: calibri!important;border: 1px solid gray!important;background: #FFF!important;" width="2%"><center>#</center></th>
		...
		<?php 
			...
			?>
				...
				<tr>
					<td colspan="2" style="border: 1px solid #C8C8C8!important;font-size: 10pt!important;font-family: calibri!important;padding-left: 10px!important;padding-right: 10px!important;background: lightgray;border-right: 4px solid #FFFFFF!important;">
							
						<b style="color: black;"><?php echo $dept->department; ?></b>

					</td>
					<td colspan="<?php echo $i; ?>" style="border-right: 4px solid #FFFFFF!important;"></td>
				</tr>
			...
			?> 
			<tr>
				<td style="border: 1px solid #C8C8C8!important;font-size: 8pt!important;font-family: calibri!important;padding-left: 10px!important;padding-right: 10px!important;background: #F8F8F8;border-top: 1px solid black;">
					<center>
						<?php echo $a; ?>
					</center>
				</td>
				<td style="border: 1px solid #C8C8C8!important;font-size: 8pt!important;font-family: calibri!important;padding-left: 10px!important;padding-right: 10px!important;background: #F8F8F8;border-top: 1px solid black;box-shadow: 5px 0 5px -5px #333;"><?php echo $sched->full_name; ?></td>
							...
							if ($date_sched->employee_id == $sched->employee_id){
								...
								if($date_sched->date == $date->format("Y-m-d")){
									...
									if ($date_sched->is_day_off == 1){ ?>
										...
										<td style="font-size: 9pt!important;font-family: calibri!important;;border-left: 4px solid #FFFFFF!important;border-top: 4px solid #FFFFFF!important;border-bottom: 4px solid #FFFFFF!important;background: #fff!important;padding: 5px;border: 4px solid #FFFFFF; " width="5%">
									...
									<?php
										...
										<td style="font-size: 7pt!important;font-family: calibri!important;border-left: 4px solid #FFFFFF!important;border-top: 4px solid #FFFFFF!important;border-bottom: 4px solid #FFFFFF!important;background: #27ae60!important;padding: 5px;color: #FFFFFF;" width="5%">
