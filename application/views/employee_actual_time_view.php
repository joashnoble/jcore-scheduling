            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="EmployeeActualTime">Employee Actual Time In / Out</a></li>
                    </ol>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <button type="button" class="btn col-sm-12 form-control" id="print_actual_time" style="background-color:#27ae60;color:white;margin-top: 10px;">
                                ...
                                <hr>
                                <div id="emp_actual_time_in_out" style="overflow: scroll;"></div>
...
$(document).ready(function(){
    ...
    var getScheduleTime=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"EmployeeActualTime/schedule/emp_actual_time",
            "data":_data,
            "beforeSend" : function(){
    ...
    $('input[type=radio][name=period]').on("change",function(){
        ...
        getScheduleTime().done(function(response){
    ...
    $('#print_actual_time').click(function(event){
            showinitializeprint();
